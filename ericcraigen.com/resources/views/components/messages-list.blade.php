...
<div class="messages test">
    ...
    <form class="messages-search-bar" method="GET" action="/account/messages">
        <div class="input-group">
            ...
            <input class="messages-search-input form-control" type="text" placeholder="Search" name="messages-search-input" id="messages-search-input">
        </div>
        @csrf
    </form>
    ...
    <div class="messages-list">
        @php
            ...
            $trashed = array();
        @endphp
        @foreach (json_decode($allMessages) as $message)
        ...
        @if (($message->messageStarred == false || $message->messageStarred == null)
            && ($message->messageSnoozed == false || $message->messageSnoozed == null)
            && ($message->messageTrashed == false || $message->messageTrashed == null))
            @php
